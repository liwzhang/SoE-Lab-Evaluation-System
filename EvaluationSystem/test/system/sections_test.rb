...
class SectionsTest < ApplicationSystemTestCase
  ...
  test "creating a Section" do
    ...
    fill_in "Catalog", with: @section.catalog
    fill_in "Class num", with: @section.class_num
    fill_in "Completed", with: @section.completed
    fill_in "Enrolled", with: @section.enrolled
    fill_in "Section", with: @section.section
    fill_in "Subject", with: @section.subject
    fill_in "Title", with: @section.title
    fill_in "User id", with: @section.user_ID
